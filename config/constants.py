...
_MODEL_SPECS = [
    ...
    ("Distil Whisper large-v3.5", "whisper-distil-large-v3.5", "float32", 160, 4, "3.0 GB"),
    ("Distil Whisper large-v3.5", "whisper-distil-large-v3.5", "bfloat16", 160, 4, "3.0 GB"),
    ("Distil Whisper large-v3.5", "whisper-distil-large-v3.5", "float16", 160, 4, "3.0 GB"),
